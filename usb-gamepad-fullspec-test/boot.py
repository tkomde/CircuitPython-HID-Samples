...
gamepad = usb_hid.Device(
    report_descriptor=bytes((
        ...
        0x95, 0x01,  # Report Count (1)
        # Input (Const,Var,Abs,No Wrap,Linear,Preferred State,No Null Position)
        0x81, 0x03,
        0x05, 0x01,  # Usage Page (Generic Desktop Ctrls)
        0x09, 0x35,  # Usage (Rz)
        0x15, 0x00,  # Logical Minimum (0)
        ...
        0x75, 0x04,  # Report Size (4)
        0x95, 0x01,  # Report Count (1)
        # Output (Const,Var,Abs,No Wrap,Linear,Preferred State,No Null Position,Non-volatile)
        0x91, 0x03,
    ...
    usage_page=0x01,
    usage=0x05,
    report_ids=(0x01, 0x02, 0x03, 0x04,),
    in_report_lengths=(15, 1, 8, 1,),
    out_report_lengths=(0, 0, 0, 0, )
)
